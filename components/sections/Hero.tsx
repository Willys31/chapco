...
const TICKER_ITEMS = [
  'Attiéké', '•', 'Huile de palme', '•', 'Karité', '•',
  'Hévéa', '•', 'Hibiscus', '•', 'Coco', '•', 'Farine de manioc', '•',
  'Graine de palme', '•', "Feuilles d'hibiscus", '•',
];
...
export function Hero() {
  ...
  useGSAP(() => {
    ...
    tl.from('.hero-eyebrow', { y: 24, opacity: 0, duration: 0.8, ease: 'expo.out' })
      .from('.hero-line', { y: 80, opacity: 0, stagger: 0.1, duration: 1.2, ease: 'expo.out' }, '-=0.4')
        ...
        <div className="order-2 lg:order-1 text-center lg:text-left">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-[5.5rem] font-light tracking-tight leading-[1.06] text-white mb-8">
            ...
            <span className="hero-line block overflow-hidden">
              <span className="block">du terroir <em className="italic text-sage-300">africain</em></span>
            </span>
            <span className="hero-line block overflow-hidden"><span className="block">aux marchés du monde</span></span>
          </h1>

          <p className="hero-subtitle text-base md:text-lg font-light text-cream/60 tracking-wide mb-12 max-w-md mx-auto lg:mx-0">
            Négoce de matières premières agricoles &amp; alimentaires depuis Abidjan
          </p>
