        ...
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <FadeIn delay={0.15}>
            <h2 className="text-4xl md:text-5xl font-light text-white tracking-tight mb-6">
              Le monde,{' '}
              <em className="italic text-sage-300">à portée de port.</em>
            </h2>
          </FadeIn>
          <FadeIn delay={0.25}>
            <p className="text-lg text-white/50 font-light leading-relaxed">
              Nos principaux ports de destination, avec d&apos;autres options sur demande
              selon votre marché.
            </p>
          </FadeIn>
        </div>
              ...
              >
                ...
                <p
                  className={`text-lg font-medium mb-1 ${
                    dest.highlight ? 'text-white' : 'text-white/70'
                  }`}
                >
                  {dest.name}
                </p>
                <p
                  className={`text-sm mb-1 ${dest.highlight ? 'text-white/70' : 'text-white/40'}`}
                >
                  {dest.country}
                </p>
                <p
                  className={`text-xs uppercase tracking-[0.15em] ${
                    dest.highlight ? 'text-sage-300' : 'text-white/30'
                  }`}
                >
                  {dest.region}
                </p>
